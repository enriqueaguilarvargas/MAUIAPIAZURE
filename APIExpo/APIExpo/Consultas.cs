   ...
   public class Consultas
    {
        ...
        public List<Datos> ConsultaRegistro(int ID)
        {
            ...
            var connect = new SqlConnection
                        ("Server=tcp:[Subdominiodetuservidor].database.windows.net,1433;Initial Catalog=[BasedeDatos];Persist Security Info=False;User ID=[TuUsuario];Password=[TuPassword];MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
